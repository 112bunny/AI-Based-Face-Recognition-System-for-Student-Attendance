...
class Student:
    def __init__(self, root):
        ...
        main_frame.place(x=10,y=55,width=1490,height=650)
        ...
        img_left = Image.open(r"C:\face_recognition\pic\image1-3-1073x715.jpg")
  ...
  #course
        ...
        year_combo.grid(row=1,column=1,padx=2,pady=10,sticky=W)
          ...
          #semester
        semester_label=Label(current_course_frame,text="Course",font=("times new roman",12,"bold"),bg="white")
        ...
        #gender
        gender__label=Label(class_student_frame,text="Gender:",font=("times new roman",12,"bold"),bg="white")
        gender__label.grid(row=2,column=0,padx=10,pady=5,sticky=W)

       # gender__entry=ttk.Entry(class_student_frame,textvariable=self.var_gender,width=20,font=("times new roman",12,"bold"))
        #gender__entry.grid(row=2,column=1,padx=10,pady=5,sticky=W)
        ...
        Right_frame.place(x=750,y=10,width=650,height=580)

        img_right = Image.open(r"C:\face_recognition\pic\8ef0bb374.jpg")
 ...
 #*************search system***********
        ...
        seach_entry=ttk.Entry(search_frame,width=15,font=("times new roman",12,"bold"))
        seach_entry.grid(row=0,column=2,padx=10,pady=5,sticky=W)

        seach_btn=Button(search_frame,text="Seach",width=11,font=("times new roman",12,"bold"),bg="blue",fg="white")
    ...
    def update_data(self):
        if (
            ...
            try:
                ...
                conn.commit() 
                self.fetch_data() # Commit the changes to the database here
                conn.close()
