...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        img1 = img1.resize((520, 150), Image.Resampling.LANCZOS)
        ...
        #attendence button
        img6 = Image.open(r"C:\face_recognition\pic\6612036.png")
        ...
        b1_1.place(x=200,y=580,width=220,height=40)
         ...
         #attendence button
        img9= Image.open(r"C:\face_recognition\pic\otug.png")
    ...
    def iExit(self):
        self.iExit=tkinter.messagebox.askyesno("Face Recognition","Are you sure to exit the window?")
        if self.iExit>0:
            self.root.destroy()
        else:
            return
